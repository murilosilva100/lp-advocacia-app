...
const serviceLinks = [
  ...
  { label: "Cível", path: "/advogadocivel", active: true },
...
export default function HeaderAdvCivel() {
  ...
  return (
    <div id="tpcivel-header">
      <nav id="tpcivel-navbar" className="service-page-header-nav">
        <Link to="/">
        ...
        <div className="tpcivel-navbar-container service-page-navbar" aria-label="Áreas de atuação">
