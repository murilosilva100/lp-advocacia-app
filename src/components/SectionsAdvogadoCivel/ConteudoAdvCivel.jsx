    ...
    <div id="tpcivel-conteudo">
      <section id="tpcivel-container-conteudo">
        <div id="tpcivel-text">
          ...
          <p id="sections-texts">
            Um advogado cível é o profissional que resolve conflitos do dia a
            dia entre pessoas, empresas ou instituições, sem envolver questões
            criminais. Ele atua em situações como cobranças de dívidas,
            contratos descumpridos, disputas entre vizinhos, problemas
            condominiais, direito do consumidor, indenizações por danos
            materiais ou morais, inventários e partilha de bens.
            <br />
            <br />
            Também cuida de questões imobiliárias como despejo e discussões
            sobre propriedade, além de diversos outros casos onde há desacordos
            que precisam ser resolvidos. O trabalho começa analisando o caso,
            reunindo documentos e provas, tentando acordos extrajudiciais quando
            possível e, se necessário, ingressando com ação judicial.
            <br />
            <br />
            No dia a dia, esse profissional elabora petições, comparece a
            audiências, negocia acordos e acompanha processos. Diferente do
            criminalista que lida com crimes e prisões, o advogado cível busca
            principalmente reparação financeira, cumprimento de obrigações ou
            reconhecimento de direitos.
            <br />
            <br />
            É o profissional que você procura quando tem problemas
            relacionados ao seu patrimônio, contratos, relações comerciais ou
            familiares, ou quando alguém lhe causou prejuízo e você quer ser
            ressarcido através de uma sentença judicial.
          </p>
          <h2 id="tpcivel-section-title">
            Quando devo buscar um advogado cível?
          </h2>
          <p id="sections-texts">
            Uma pessoa deve buscar um advogado cível quando se sentir lesada em
            seus direitos ou patrimônio e não conseguir resolver a situação
            amigavelmente. Isso inclui casos como produtos ou serviços
            defeituosos não resolvidos pela empresa, acidentes que causaram
            prejuízos por culpa de terceiros, nome negativado indevidamente,
            cobranças injustas ou contratos não cumpridos. 
            <br />
            <br />
            Questões familiares e
            patrimoniais também demandam esse profissional. Divórcio com
            partilha de bens, inventário, disputas de herança, pensão
            alimentícia, problemas com imóveis, disputas de vizinhança ou
            cobranças condominiais abusivas são exemplos comuns que requerem
            assistência jurídica especializada. 
            <br />
            <br />
            O ideal é procurar um advogado
            cível assim que perceber um conflito que pode se agravar ou quando
            tentativas de resolver sozinho falharam. Quanto mais cedo buscar
            orientação, maiores as chances de proteger seus direitos, reunir
            provas adequadas e encontrar a melhor solução, seja por negociação
            ou ação judicial.
          </p>
          <h2 id="tpcivel-section-title">
